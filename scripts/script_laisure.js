...
fetch('http://localhost:8080/laisure')
...
function carregaElementosNaPagina(json) {
    ...
    for (let vehicle of json) {
        ...
        td8.innerHTML = vehicle.nrPortas;
        tr.appendChild(td8);

        let td9 = document.createElement('td');
        td9.innerHTML = vehicle.corInterna;
        tr.appendChild(td9);

        let td10 = document.createElement('td');
        td10.innerHTML = vehicle.corExterna;
        tr.appendChild(td10);
   
        let btnEdit = document.createElement('button')
        btnEdit.classList.add('btnEdit');
        let linkEdit = document.createElement('a');
        linkEdit.setAttribute('href', 'veiculos_passeio_editar.html');
        ...
        linkDelete.setAttribute('href', 'http://localhost:8080/laisure/delete/' + vehicle.id);
